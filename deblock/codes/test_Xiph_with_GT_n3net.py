...
'''
python ~/zhouhuanxiang/mmsr/codes/test_Xiph_with_GT_n3net.py

nohup python ~/zhouhuanxiang/mmsr/codes/test_Xiph_with_GT.py > ~/zhouhuanxiang/test_EDVR9_Xiph37_woTSA_M 2>&1 &
'''
...
def main():
    ...
    #### model
    test_name = 'test_n3net_Xiph37'
    # model_path = '/home/web_server/zhouhuanxiang/disk/log/experiments/EDVR8_semi_C_Xiph37_woTSA_M_1/models/80000_G.pth'
    model_path = '/home/web_server/zhouhuanxiang/disk/log/experiments/n3net_Xiph/models/50000_G.pth'
    N_in = 5
    import models.archs.n3net.n3net as n3net
    model = n3net.N3NetVideo(64, 5, 5, 10)
    #### dataset
    ...
    metainfo_path = '/home/web_server/zhouhuanxiang/mmsr/codes/data_scripts/y4m_test_metainfos_10_7.json'
