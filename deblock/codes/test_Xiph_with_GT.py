...
'''
python ~/zhouhuanxiang/mmsr/codes/test_Xiph_with_GT.py

nohup python ~/zhouhuanxiang/mmsr/codes/test_Xiph_with_GT.py > ~/zhouhuanxiang/test_EDVR_haar15 2>&1 &
'''
...
def main():
    ...
    #### model
    test_name = 'EDVR_haar15_Xiph37_woTSA_M'
    # model_path = '/home/web_server/zhouhuanxiang/disk/log/experiments/EDVR8_semi_C_Xiph37_woTSA_M_1/models/80000_G.pth'
    model_path = '/home/web_server/zhouhuanxiang/disk/log/experiments/EDVR_haar15_Xiph37_woTSA_M/models/latest_G.pth'
    N_in = 5
