...
'''
nohup python ~/zhouhuanxiang/mmsr/codes/test_Xiph_TOF_with_GT.py > ~/zhouhuanxiang/test_Xiph_TOF_with_GT 2>&1 &
'''
...
def main():
    ...
    #### model
    test_name = 'TOF_Pwc_Xiph37'
    model_path = '/home/web_server/zhouhuanxiang/disk/log/experiments/TOF_Pwc_Xiph37/models/latest_G.pth'
    N_in = 7
    model = TOF_Pwc_arch.TOFPwclow()
    #### dataset
    ...
    metainfo_path = '/home/web_server/zhouhuanxiang/mmsr/codes/data_scripts/y4m_test_metainfos_6_fast.json'
    ...
    for video_name in metainfos.keys():
        ...
        # video_length = 10
        # padding
        need_padding_x = (video_width % 64 != 0)
        need_padding_y = (video_height % 64 != 0)
        padding_left = 0
        padding_right = 0
        padding_top = 0
        padding_buttom = 0
        if need_padding_x:
            padding_x = 64 - video_width % 64
            padding_left = padding_x // 2
            padding_right = padding_x - padding_left
        if need_padding_y:
            padding_y = 64 - video_height % 64
        ...
        save_subfolder = osp.join(save_folder, 'Xiph_test', video_name)
