...
class XiphSemiDatasetB(data.Dataset):
    '''
    ...
    def __init__(self, opt):
        super(XiphSemiDatasetB, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        if N_frames == 1:
            return {'LQ': img_LQs[0], 'GT': img_GTs[0], 'key': video_name+'_'+str(center_frame_idx)}
        else:
            return {'LQs': img_LQs, 'GTs': img_GTs, 'key': video_name+'_'+str(center_frame_idx)}
