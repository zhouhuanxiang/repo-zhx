...
class XiphCutBlurDataset(data.Dataset):
    '''
    ...
    def __init__(self, opt):
        super(XiphCutBlurDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        if N_frames == 1:
            ...
            rnd_h = random.randint(0, GT_size / 2 - 1)
            rnd_w = random.randint(0, GT_size / 2 - 1)
            if mode == 0:
                img_LQs[0, :, rnd_h:rnd_h + GT_size // 2, rnd_w:rnd_w + GT_size // 2] = \
                    img_GT[:, rnd_h:rnd_h + GT_size // 2, rnd_w:rnd_w + GT_size // 2]
            elif mode == 1:
                tmp = img_GT
                tmp[:, rnd_h:rnd_h + GT_size // 2, rnd_w:rnd_w + GT_size // 2] = \
                    img_LQs[0, :, rnd_h:rnd_h + GT_size // 2, rnd_w:rnd_w + GT_size // 2]
                img_LQs[0] = tmp
