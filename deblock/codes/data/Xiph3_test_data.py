...
class Xiph3TestDataset(data.Dataset):
    '''
    ...
    def __init__(self, opt):
        super(Xiph3TestDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        LQ_root = self.LQ_root[index // len(self.sample_list)]
        ...
        #### get LQ image
        img_LQ = util.read_yuv_frame(LQ_root, video_name,
        ...
        LQ_path = '{}_{}/{:05d}.png'.format(LQ_qp, video_name, center_frame_idx)
        # print(img_LQ.shape, LQ_path)

        return {'LQ': img_LQ, 'LQ_path': LQ_path, 'QP': LQ_qp}


    def __len__(self):
        return len(self.sample_list) * 3
