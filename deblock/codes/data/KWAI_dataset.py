...
class KWAIDataset(data.Dataset):
    '''
    Reading the training KWAI dataset
    ...
    def __init__(self, opt):
        super(KWAIDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        if self.data_type == 'mc':
            ...
            img_GT = util.read_img(self.GT_env, key, (3, 1280, 720))
        else:
        ...
        LQ_size_tuple = (3, 180, 320) if self.LR_input else (3, 1280, 720)
        img_LQ_l = []
        for v in neighbor_list:
            ...
            if self.data_type == 'mc':
                ...
                img_LQ = util.read_img(self.LQ_env, '{}_img_{:05d}'.format(name_a, v), LQ_size_tuple)
            else:
