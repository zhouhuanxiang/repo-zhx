...
% matlab -nodisplay -nosplash -nodesktop -r "run('~/zhouhuanxiang/mmsr/codes/evaluation/calculate_PSNR_SSIM.m');exit;" | tail -n +11


% GT and SR folder
%folder_GT = '/home/web_server/zhouhuanxiang/disk/data/HD_UGC_raw_test';
%folder_SR  = '/home/web_server/zhouhuanxiang/disk/log/results/MSRGANx1_KWAI40/KWAI-test';
scale = 1;
