...
class SRGANPhase2Model(BaseModel):
    def __init__(self, opt):
        super(SRGANPhase2Model, self).__init__(opt)
        if opt['dist']:
        ...
        self.netG_phase1 = SRResNet_arch.MSRResNet(in_nc=3, out_nc=3, nf=32, nb=8, upscale=1)
        ...
        if self.w_phase1:
            ...
            self.load_network('/home/web_server/zhouhuanxiang/disk/log/experiments/train_SRResNet_ssim_KWAI253035plus_slim7/models/latest_G.pth',
                              self.netG_phase1, True)
    ...
    def test_single(self):
        self.netG.eval()
        with torch.no_grad():
                self.fake_H = self.netG_phase1(self.var_L)
