...
class PCD_Align(nn.Module):
    ...
    def __init__(self, nf=64, groups=8):
        ...
        self.L3_dcnpack = nn.Conv2d(nf, nf, 3, stride=1, padding=1, dilation=1, groups=groups)
        ...
        #                       extra_offset_mask=True)
        self.L2_dcnpack = nn.Conv2d(nf, nf, 3, stride=1, padding=1, dilation=1, groups=groups)        
        ...
        #                       extra_offset_mask=True)
        self.L1_dcnpack = nn.Conv2d(nf, nf, 3, stride=1, padding=1, dilation=1, groups=groups)        
        ...
        #                        extra_offset_mask=True)
        self.cas_dcnpack = nn.Conv2d(nf, nf, 3, stride=1, padding=1, dilation=1, groups=groups)
    ...
    def forward(self, nbr_fea_l, ref_fea_l):
        ...
        L3_fea = self.lrelu(self.L3_dcnpack(nbr_fea_l[2]))
        # L2
        ...
        L2_fea = self.L2_dcnpack(nbr_fea_l[1])
        ...
        L1_fea = self.L1_dcnpack(nbr_fea_l[0])
        ...
        L1_fea = self.lrelu(self.cas_dcnpack(L1_fea))
