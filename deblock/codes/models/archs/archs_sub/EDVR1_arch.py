...
class PCD_Align(nn.Module):
    ...
    def forward(self, nbr_fea_l, ref_fea_l):
        ...
        L3_fea = F.interpolate(ref_fea_l[2] - L3_fea, scale_factor=2, mode='bilinear', align_corners=False)
        ...
        L2_fea = F.interpolate(ref_fea_l[1] - L2_fea, scale_factor=2, mode='bilinear', align_corners=False)
