...
class EBRN(nn.Module):
    def __init__(self):
        ...
        self.brm5 = Block_Residual_Module(True)
        self.brm6 = Block_Residual_Module(True)
        self.brm7 = Block_Residual_Module(True)
        self.brm8 = Block_Residual_Module(True)
        self.brm9 = Block_Residual_Module(True)
        self.brm10 = Block_Residual_Module(False)
        ...
        self.fusion56 = nn.Conv2d(64, 64, 3, 1, 1, bias=True)
        self.fusion67 = nn.Conv2d(64, 64, 3, 1, 1, bias=True)
        self.fusion78 = nn.Conv2d(64, 64, 3, 1, 1, bias=True)
        self.fusion89 = nn.Conv2d(64, 64, 3, 1, 1, bias=True)
        self.fusion910 = nn.Conv2d(64, 64, 3, 1, 1, bias=True)

        self.recon1 = nn.Conv2d(64, 64, 3, 1, 1, bias=True)
    ...
    def forward(self, x):
        ...
        O9 = self.lrelu(self.fusion910(O9 + O10))
        O8 = self.lrelu(self.fusion89(O8 + O9))
        O7 = self.lrelu(self.fusion78(O7 + O8))
        O6 = self.lrelu(self.fusion67(O6 + O7))
        O5 = self.lrelu(self.fusion56(O5 + O6))
        ...
        # O_concat = torch.cat((O1, O2, O3, O4, O5, O6, O7, O8, O9, O10), dim=1)
        O_concat = O1 + O2 + O3 + O4 + O5 + O6 + O7 + O8 + O9 + O10
