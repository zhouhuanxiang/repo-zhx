...
class PCD_Align(nn.Module):
    ...
    def forward(self, nbr_fea_l, ref_fea_l):
        ...
        L2_offset = self.lrelu(self.L2_offset_conv2(self.cbam1(torch.cat([L2_offset, L3_offset * 2], dim=1))))
        ...
        L1_offset = self.lrelu(self.L1_offset_conv2(self.cbam2(torch.cat([L1_offset, L2_offset * 2], dim=1))))
