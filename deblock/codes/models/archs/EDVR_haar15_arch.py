...
from models.archs.scatnet_learn import InvariantLayerj1
...
class EDVR(nn.Module):
    def __init__(self, nf=64, nframes=5, groups=8, front_RBs=5, back_RBs=10, center=None,
        ...
        self.conv_first = nn.Conv2d(3, 8, 3, 1, 1, bias=True)
        ...
        self.frontend = nn.Sequential(OrderedDict([
            ('order1', InvariantLayerj1(8, F = 8)),
            ('order2', InvariantLayerj1(8, F = 64))]))
