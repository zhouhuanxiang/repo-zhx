...
import models.modules.u2net as u2net
import models.modules.u2net_2 as u2net_2
import models.modules.u2net_3 as u2net_3
import models.modules.unet_attn as unet_attn
import models.modules.dpdd_s12_dunet_ab10 as dpdd_s12_dunet_ab10

import models.modules.MPRNet as MPRNet
...
def define_G(opt):
    ...
    elif which_model == 'u2net':
        netG = u2net.U2NET_lite()
    elif which_model == 'u2net_2':
        netG = u2net_2.U2NET_lite()
    elif which_model == 'u2net_3':
        netG = u2net_3.U2NET_lite()
    elif which_model == 'unet_attn':
        if 'mode' in opt_net.keys():
            netG = unet_attn.AttU_Net(3, 3, mode=str(opt_net['mode']))
        else:
            netG = unet_attn.AttU_Net(3, 3)
    elif which_model == 'dpdd_s12_dunet_ab10':
        netG = dpdd_s12_dunet_ab10.dpdd_s12_dunet_ab10(opt_net)
