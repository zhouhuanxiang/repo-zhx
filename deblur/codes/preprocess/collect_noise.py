...
if __name__ == '__main__':
    ...
    # img_dir = '/home/web_server/zhouhuanxiang/disk/data_test/DPEDiphone-va'
    # noise_dir = '/home/web_server/zhouhuanxiang/disk/Real-SR-master/DPEDiphone_noise'

    img_dir = '/media/disk1/fordata/web_server/huangxiaozheng/hot_blur_qualified/*'
    noise_dir = '/home/web_server/zhouhuanxiang/disk/Real-SR-master/kwai_noise'
    ...
    img_paths = sorted(glob.glob(osp.join(img_dir, '*0.png')))
    print(len(img_paths))
    cnt = 0
...
python /home/web_server/zhouhuanxiang/disk/Real-SR-master/codes/preprocess/collect_noise.py
